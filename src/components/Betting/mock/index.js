export const doubleChoiceData = {
  ...
  choices: [
    { number: 1, cote: '2.80', label: 'Nadal', link: 'http://google.fr' },
    { number: 2, cote: '1.70', label: 'Federer', link: 'http://bing.fr' },
  ],
};
...
export const tripleChoiceData = {
  ...
  choices: [
    ...
    { number: 3, cote: '1.70', label: 'Federer', link: 'http://bing.fr' },
  ],
};
